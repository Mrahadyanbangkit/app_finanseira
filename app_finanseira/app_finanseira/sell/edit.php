                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-secondary btn-sm" onclick="window.location.href='<?= $base_url ?>sell'">Kembali</button>
                                </div>
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="jenis_penjualan" class="col-form-label col-form-label-sm">Jenis Penjualan</label>
                                        ...
                                        <div class="form-group">
                                            <label for="tipe" class="col-form-label col-form-label-sm">Pilihlah Kas</label>
