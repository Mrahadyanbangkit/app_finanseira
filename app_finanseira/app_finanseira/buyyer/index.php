                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='<?= $base_url ?>buyyer/create.php'">Tambah Data</button>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= ($row['tipe']) ?></td>
                                                    <td><a href="<?= $base_url ?>buyyer/edit.php?id=<?= $row['buy_id'] ?>">Edit</a> | <a href="<?= $base_url ?>buyyer/delete.php?id=<?= $row['buy_id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a></td>
                                                </tr>
                                            <?php
                                            endforeach;
                                            ?>
