                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Rekap Data Laporan</h6>
                                </div>
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody>
                                            ...
                                            $subtotalPendapatan = $subtotalLabaBersih + $subtotalPenjualan +  $subtotalLabaKotor + $subtotalPiutang ;
                                            $subtotalPengeluaran = $subtotalBeban + $subtotalPembelian + $subtotalPajak ;
