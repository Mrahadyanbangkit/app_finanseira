                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($row['user_id'] == $account['user_id']) : ?>
                                                            <a href="<?= $base_url ?>customer_support/edit.php?id=<?= $row['cs_id'] ?>">Edit</a> | <a href="<?= $base_url ?>customer_support/delete.php?id=<?= $row['cs_id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                                                        <?php else : ?>
                                                            Access Denied
                                                        <?php endif; ?>
                                                    </td>
